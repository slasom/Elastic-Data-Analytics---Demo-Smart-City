...
public class HeatMapResource {
    ...
    public Exception executeMethod(HeatMapResponse response){
    ...
    public void getMCHeatmaps (Date beginDate, Date endDate, Double latitude, Double longitude, Double radius, Integer devices){
        ...
        Log.i("getMCHeatmaps", " LLega aquí");

        List<LocationFrequency> locations = LocationManager.getLocationHistory(beginDate, endDate, latitude, longitude, radius);
        Log.i("Locations", String.valueOf(locations));

        try {
            sendReplyMQTT(mapResponse.getSender(), mapResponse.getIdRequest(),new JSONArray(gson.toJson(locations)));
        } catch (JSONException e) {
            //e.printStackTrace();
            Log.i("Fallo", "falla  en el reply");
    ...
    private void sendReplyMQTT(String url, String idRequest, JSONArray list) throws MqttException, UnsupportedEncodingException {
